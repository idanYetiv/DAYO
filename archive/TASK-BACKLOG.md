...
- Task 2: Database hooks - Tasks (useTasks.ts)
- Task 3: Database hooks - Diary (useDiary.ts)
- Task 4: Database hooks - User Stats (useUserStats.ts)

### In Progress ⏳
- None yet

### Blocked 🚫
- Task 1: Supabase setup (need credentials)
- Tasks 5-18 (waiting for Task 1)
